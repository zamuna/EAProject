	...
	<div class="container-fluid display-table">
		<div class="row display-table-row">
			<div
				...
				<div class="navi">
					<ul>
						<li class="active"><a href="/redirect/url"><i class="fa fa-home"
						...
						<li><a href="#"><i class="fa fa-bar-chart"
								aria-hidden="true"></i><span class="hidden-xs hidden-sm">Filter</span></a></li>
						<li><a href="displayuser"><i class="fa fa-user" aria-hidden="true"></i><span
								class="hidden-xs hidden-sm">User</span></a></li>
						<li><a href="#"><i class="fa fa-calendar"
								aria-hidden="true"></i><span class="hidden-xs hidden-sm"></span></a></li>
										...
										<ul class="dropdown-menu">
											<li>
												<div class="navbar-content">
													...
													<a href="#" class="view btn-sm active">logout</a>
												</div>
											</li>
										</ul></li>
								</ul>
...
.login-header .nav-tabs>li.active>a, .login-header .nav-tabs>li.active>a:focus,
...
.login-header .nav>li>a:focus, .login-header .nav>li>a:hover {
	background: none;
	text-decoration: none;
}
...
.user input {
	background: rgba(0, 0, 0, 0) url("../images/user.png") no-repeat scroll
		7px 12px;
}

.pass input {
	background: rgba(0, 0, 0, 0) url("../images/password.png") no-repeat
		scroll 7px 12px;
}
...
.add-project::before {
	background: rgba(0, 0, 0, 0) url("../images/plus.png") no-repeat scroll
		0 0;
	content: "";;
	height: 12px;
	left: 17px;
...
.modal-header.login-header {
	...
	/*Main CSS*/ @media only screen and (max-device-width: 767px) {
	.login-logo img {
	margin: 0 auto;
}
...
#navigation .navi a:hover, #navigation .navi .active a {
	background: #122143 none repeat scroll 0 0;
	border-left: none;
	display: block;
	padding-left: 20px;
...
@media only screen and (min-device-width:998px) and (max-device-width:
	1350px) {
	#navigation .logo img {
		max-width: 130px;
		padding: 16px 0 17px;
